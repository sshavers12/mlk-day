-- Migration: Upgrade Station Visuals & Data logic (v2)
...
-- Cleanup old slugs if they exist and are no longer needed
-- (Optional: comment out if you want to keep them as backups)
-- DELETE FROM public.stations WHERE slug IN ('university-place-cafeteria', 'alumni-auditorium', 'harris-hall', 'latham-hall');
